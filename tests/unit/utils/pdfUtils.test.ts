	...
	describe('PDFManager', () => {
		describe('loadFromFile', () => {
			...
			it('should handle file reading errors', async () => {
				...
				await expect(pdfManager.loadFromFile(mockFile as any)).rejects.toThrow(
		...
		describe('renderPage', () => {
			...
			it('should handle page rendering errors', async () => {
				...
				await expect(pdfManager.renderPage(99, options)).rejects.toThrow(
					'Failed to render page 99'
				);
			});
		});
		...
		describe('getPageDimensions', () => {
			...
			it('should handle errors when getting dimensions', async () => {
				...
				await expect(pdfManager.getPageDimensions(1)).rejects.toThrow(
					'Failed to get dimensions for page 1'
				);
			});
		});
